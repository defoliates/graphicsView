...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RectItem_t, stringdata) + ofs \
...
const QMetaObject RectItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RectItem.data,
      qt_meta_data_RectItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RectItem.stringdata))
        return static_cast<void*>(const_cast< RectItem*>(this));
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< RectItem*>(this));
